...
-- Public functions
function init()  
   bagIcon = modules.client_topmenu.addCustomRightButton('bag_icon', 'Inventory', path..'bag_icon_apagado', toggleBagIcon, true)
   bagIcon:setOn(false)
   bagIcon:setVisible(false)
   
   fishingIcon = modules.client_topmenu.addCustomRightButton('fishingIcon', 'Rod', path..'fishing_icon', toggleFishingIcon, true)
